# Fibered Farrell Jones Conjecture — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/fibered-farrell-jones-conjecture-canonical-lane-mathlib.git
cd fibered-farrell-jones-conjecture-canonical-lane-mathlib
lake exe
lake build
```
