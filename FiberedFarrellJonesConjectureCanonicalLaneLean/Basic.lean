/-!
# fibered-farrell-jones-conjecture-canonical-lane Lean migration boundary
...
`FiberedFarrellJonesConjectureCanonicalLaneLean/SourcePackage.lean`.
...
def sourceRepository : String := "fibered-farrell-jones-conjecture-canonical-lane"
def sourceUrl : String := "https://github.com/HautevilleHouse/fibered-farrell-jones-conjecture-canonical-lane"
def sourceDescription : String := "Canonical-lane closure package for the Fibered Farrell-Jones Conjecture: admissible-class formulation, projection gates, local-to-global bridge, and carried remainder."
def sourceClassification : String := "abstract_math_theorem_repo"
def sourceTopics : List String := ["canonical-lane", "local-to-global", "manifold-constrained", "fibered-farrell-jones", "geometric-group-theory", "assembly-map", "mathematical-proof", "reproducibility"]
